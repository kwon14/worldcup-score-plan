...
export const GROUP_A_STANDINGS: GroupStanding[] = [
  { rank: 1, flag: '🇲🇽', name: '멕시코', played: 2, win: 2, draw: 0, loss: 0, goalsFor: 3, goalsAgainst: 0, points: 6 },
  { rank: 2, flag: '🇰🇷', name: '대한민국', played: 2, win: 1, draw: 0, loss: 1, goalsFor: 2, goalsAgainst: 2, points: 3 },
  { rank: 3, flag: '🇨🇿', name: '체코', played: 2, win: 0, draw: 1, loss: 1, goalsFor: 2, goalsAgainst: 3, points: 1 },
  { rank: 4, flag: '🇿🇦', name: '남아프리카공화국', played: 2, win: 0, draw: 1, loss: 1, goalsFor: 1, goalsAgainst: 3, points: 1 },
];
...
export const GROUP_A_RESULTS: GroupResult[] = [
  ...
  { homeFlag: '🇲🇽', homeTeam: '멕시코', homeScore: 1, awayFlag: '🇰🇷', awayTeam: '대한민국', awayScore: 0, status: '종료', date: '6/18' },
...
export const GROUP_A_RESULTS_UPDATED_AT = 'ESPN 기준 · 2026년 6월 19일 현재';
